...
//   const { trips, players, foursomes } = useAuth()
...
//           <div>
//             <h1 className="text-3xl font-bold text-foreground">{trip.name} - Rounds</h1>
//             <p className="text-muted-foreground mt-1">Round Schedule & Foursomes</p>
//           </div>
...
//                               {round.format === "2v2" ? "2v2 Best Ball" : "1v1 Singles"} • {round.teeBox} Tees
//                               {round.drinkingMode && " • Drinking Mode"}
//                             </p>
//                           </div>
//                         </div>
//                       </CardContent>
...
//                 {rounds.map((round) => (
//                   <TabsTrigger key={round.id} value={`round-${round.id}`}>
//                     Round {round.number}
//                   </TabsTrigger>
//                 ))}
//               </TabsList>
...
//                                   {foursome.teeTime && (
//                                     <span className="text-xs text-muted-foreground">Tee Time: {foursome.teeTime}</span>
//                                   )}
//                                 </div>
